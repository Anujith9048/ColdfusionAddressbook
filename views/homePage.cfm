        ...
        <div class="col-10 mt-5 mx-auto d-flex gap-5">
            <div class="col-2  bg-white d-flex justify-content-center rounded-3 shadow-lg">
                <div class="d-block my-auto pb-5">
                    ...
                    <p class="color-address fw-bold text-center mt-2 fs-5">Anujith S</p>
                    <button type="button" class="px-3 btn address-btn fw-bold color-address ms-3 rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Create Contact
                      </button>
                      
                      <!-- Modal -->
                      <div class=" shadow-lg modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg d-flex gap-0">
                            <div class="modal-content border-0 rounded-0 rounded-start">
                                <div class="modal-header create-bg">
                                  <h5 class="modal-title color-address create-title w-100 text-center py-2 rounded-pill" id="exampleModalLabel">Create Contact</h5>
                                </div>
                                <div class="modal-body">
                                  <form action="homePage.cfm" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="fname-box">
                                            <label for="" class="color-address form-text fw-bold">First Name*</label>
                                            <input type="text" class="form-control" placeholder="First Name" id="fname" >
                                            <p id="errorFname" class="text-danger"></p>
                                        </div>
                                        
                                        <div class="lname-box">
                                            <label for="" class="color-address form-text fw-bold">Last Name*</label>
                                    ...
                                    <div class="d-flex gap-3 mt-3">
                                        ...
                                        <div class="dob-box">
                                            <label for="" class="color-address form-text fw-bold">Date of birth*</label>
                                            <input type="date" class="form-control" id="dob" >
                                            <p id="errorDob" class="text-danger"></p>
                                        </div>
                                        
                                        <div class="image-box">
                                            <label for="" class="color-address form-text fw-bold">Upload a photo*</label>
                                            <input type="file" class="form-control" id="image" name="image">
                                            <p id="errorImage" class="text-danger"></p>
                                        </div>
                                    </div>

                                    <p class=" mt-4 w-100 color-address fw-bold contact-title">Contact Details</p>
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="" class="form-text fw-bold color-address">Pin Code*</label>
            ...
            <div class="col-9 bg-white p-3 px-4 rounded-3 shadow-lg">
                <table class="table table-hover">
                    ...
                    <tbody>
                      <tr >
                        <td class="align-content-center"><img class="img-fluid" width="35" src="../images/default_user.png" alt=""></td>
                        <td class="align-content-center">Anujith</td>
                        <td class="align-content-center">@mdo</td>
                        <td class="align-content-center">9048503717</td>
                        <td class="align-content-center"><button class="btn address-btn rounded-pill">Edit</button></td>
                        <td class="align-content-center"><button class="btn address-btn rounded-pill">Delete</button></td>
                        <td class="align-content-center"><button class="btn address-btn rounded-pill">View</button></td>
                      </tr>
                    </tbody>
                  </table>
            </div>
